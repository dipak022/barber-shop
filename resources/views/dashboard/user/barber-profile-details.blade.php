...
<p class="doc-location"> SPECIALIZATION  - <a href="javascript:void(0);">{{$user->specialization}}</a></p>

<div class="clinic-details">
<p class="doc-location"> Exparience - <a href="javascript:void(0);">{{$user->experience }}</a></p>
