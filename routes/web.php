...
//user.profile.update
Route::get('user/profile/update/', [App\Http\Controllers\User\UserLogicController::class, 'UserProfileUpdate'])->name('user.profile.update');
//user.pass.change
Route::get('user/pass/change/', [App\Http\Controllers\User\UserLogicController::class, 'UserPassChange'])->name('user.pass.change');
